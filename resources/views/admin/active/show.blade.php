...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
				<input type="text" name="" id="act_title" placeholder=" 精彩活动名称" style="width:250px" class="input-text">
				<button name="" id="" class="btn btn-success ss" ><i class="Hui-iconfont">&#xe665;</i> 搜精彩活动</button>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" data-title="添加精彩活动" _href="article-add.html" onclick="article_add('添加精彩活动','{{url('admin/active/add')}}')" href="{{url('admin/active/add')}}"><i class="Hui-iconfont">&#xe600;</i> 添加精彩活动</a>
				</span>
