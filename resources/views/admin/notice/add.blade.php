...
<title>添加课程公告 - 课程公告管理 - H-ui.admin v3.0</title>
...
<article class="cl pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课程公告：</label>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>公告名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
