...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="javascript:;">
        <input type="hidden" name="lect_id" value="{{$lect->lect_id}}">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>讲师名字：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$lect->lect_name}}" placeholder="" id="" name="lect_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>授课风格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$lect->lect_style}}" placeholder="" id="" name="lect_style">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" name="lect_img" value="{{$lect->lect_img}}" id="img_paths">
                <div id="imgesap">
                    <img src='/{{$lect->lect_img}}' id="hide" width='200px'>
                </div>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="lect_resume" id="lect_resume" >{{$lect->lect_resume}}</textarea>
            </div>
        </div>
        <div class="row cl">
...
<script>
    ...
    $("#submit").click(function(){
        ...
        var	url = "/admin/lect/updDo/"+lect_id;
        $.ajax({
            //提交地址
            url:url,
            //提交方式
