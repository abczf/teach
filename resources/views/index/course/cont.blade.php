    ...
    <div class="coursecont">
        <div class="coursepic">
            ...
            <div class="coursetitle">
                ...
                <span class="coursebtn"><a class="btnlink" href="{{url('index/detail/info')}}">加入学习</a><a class="codol fx" href="javascript:void(0);" onClick="$('#bds').toggle();">分享课程</a><a class="codol sc" href="#">收藏课程</a></span>
